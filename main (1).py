    ...
    if choice == 3 :
      ...
      while choice != 99:
        ...
        if choice == 4 : 
          ...
          os.system("clear")
        if choice == 5 :
          print("suma de los cuadrados de los cien primeros números naturales")
          suma = 0
          for i in range(1,101):
            suma = suma + i**2
